...
DIGITAL_ETHICS_TOPICS = [
    {"label": "딥페이크와 초상권", "title": "딥페이크와 초상권 침해, 어디까지 허용해야 할까?", "mode": "⚔️ 찬반 토론"},
    {"label": "AI 창작물 저작권", "title": "AI가 만든 작품, 저작권은 누구에게 있을까?", "mode": "⚔️ 찬반 토론"},
    {"label": "온라인 개인정보", "title": "온라인 개인정보, 어디까지 제공해도 될까?", "mode": "⚔️ 찬반 토론"},
    {"label": "사이버 폭력과 표현의 자유", "title": "사이버 폭력, 표현의 자유와 어디서 선을 그어야 할까?", "mode": "⚔️ 찬반 토론"},
    {"label": "AI 챗봇과 사고력", "title": "AI 챗봇 의존, 우리의 사고력에 도움일까 방해일까?", "mode": "⚔️ 찬반 토론"},
    {"label": "AI 활용과 표절", "title": "과제에 AI를 활용하는 것, 어디까지가 표절일까?", "mode": "⚔️ 찬반 토론"},
    {"label": "AI 알고리즘 편향", "title": "AI 알고리즘의 편향, 누구의 책임일까?", "mode": "💡 자유 토의"},
]
