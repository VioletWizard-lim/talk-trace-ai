...
DIGITAL_ETHICS_TOPICS = [
    "딥페이크와 초상권 침해, 어디까지 허용해야 할까?",
    "AI가 만든 작품, 저작권은 누구에게 있을까?",
    "온라인 개인정보, 어디까지 제공해도 될까?",
    "사이버 폭력, 표현의 자유와 어디서 선을 그어야 할까?",
    "AI 챗봇 의존, 우리의 사고력에 도움일까 방해일까?",
    "과제에 AI를 활용하는 것, 어디까지가 표절일까?",
    "AI 알고리즘의 편향, 누구의 책임일까?",
]
